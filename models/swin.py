...
if __name__ == "__main__":
    ...
    net = SwinTransformerBlock(dim=64,input_resolution=(128,128),num_heads=2)
    # torch.save(net.state_dict(), 'model.pth')
    CT = torch.randn(batch_size, 64, 128, 128)    # Batchsize, modal, hight,
    ...
    print("Output:",segmentation_prediction)